		...
		<div class="game-about bx">
			...
			<div class="news" v-if="false">
				<div class="title">
					...
					<!--游戏资讯-轮播控制-->
					<div class="ctrl">
						<span class="prov" href="#carousel-example-generic" data-slide="prev"><i
								class="fa fa-angle-left"></i></span>
						<span class="next" href="#carousel-example-generic" data-slide="next"><i
						...
						<div class="item active">
							<div class="content">
								<div class="items" v-for=" v in 8">
									<div class="news-title"> <router-link to="/game_news">【公告】英雄联盟:职业选手被打哭集锦 faker
											微笑的表情扎... </router-link></div>
			...
			<div class="video" v-if="false">
				<div class="title">
					...
					<!--游戏视频-轮播控制-->
					<div class="ctrl">
						<span class="prov" href="#carousel-example-generic1" data-slide="prev"><i
								class="fa fa-angle-left"></i></span>
						<span class="next" href="#carousel-example-generic1" data-slide="next"><i
								class="fa fa-angle-right"></i></span>
					</div>
				</div>
				<!--游戏视频-轮播-->
							...
							<div class="content">
								<div class="items" style="padding:3px">
									<router-link to="/game_news">
										<img src="../../../static/img/video1.jpg" alt=""
			...
			<div class="images">
				<div class="title">
					...
					<!--游戏截图-轮播控制-->
					<div class="ctrl">
						<span class="prov" href="#carousel-example-generic2" data-slide="prev"><i
								class="fa fa-angle-left"></i></span>
						<span class="next" href="#carousel-example-generic2" data-slide="next"><i
								class="fa fa-angle-right"></i></span>
					</div>
				</div>
				<!--游戏截图-轮播-->
